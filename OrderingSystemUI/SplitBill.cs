...
namespace OrderingSystemUI
{
    public partial class SplitBill : Form
    {
        ...
        public SplitBill(Bill bill, float remainingTotal, bool finalCustomer, int customer)
        {
            ...
            txtBoxTIPsplitForm.Visible = false; //
            labelTotalwithTipSplit.Visible = false;
            labelTotalWithTIPsplitDisplay.Visible = false;
        ...
        private void checkBoxAddTIP_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxAddTIP.Checked)
            {
                txtBoxTIPsplitForm.Visible = true;
                labelTotalwithTipSplit.Visible = true;
                labelTotalWithTIPsplitDisplay.Visible = true;
            }
            else
            {
                txtBoxTIPsplitForm.Visible = false;
